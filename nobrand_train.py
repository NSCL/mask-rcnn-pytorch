...
class CocoConfig(Config):
    ...
    NUM_CLASSES = 1 + 3  # test Nobrand has 3 classes
    ...
    #STEPS_PER_EPOCH = STEPS_PER_EPOCH / (IMAGES_PER_GPU*GPU_COUNT)
...
class CocoDataset(utils.Dataset):
    def load_coco(self, dataset_dir, subset, class_ids=None,
        ...
        #COCO("dataset_dir/annotations/instances_subsetyear.json") what is coco function???
